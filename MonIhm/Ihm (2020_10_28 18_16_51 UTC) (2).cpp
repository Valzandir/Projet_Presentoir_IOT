...
PrincFrameCatalogue::PrincFrameCatalogue( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	ExporterFormation = new wxMenuItem( A_Propos, wxID_ANY, wxString( wxT("Exporter les formations") ) , wxEmptyString, wxITEM_NORMAL );
	A_Propos->Append( ExporterFormation );
	
	wxMenuItem* ListerFormations;
	ListerFormations = new wxMenuItem( A_Propos, wxID_ANY, wxString( wxT("Lister les formations") ) , wxEmptyString, wxITEM_NORMAL );
	A_Propos->Append( ListerFormations );
...
SupprimerFormationLGT::SupprimerFormationLGT( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_staticText25 = new wxStaticText( this, wxID_ANY, wxT("Choisisser l'id de la formation a supprimer"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	bSizer6->Add( TextCtrlId, 0, wxALL|wxALIGN_CENTER_HORIZONTAL, 5 );
...
ModifierFormationLGT::ModifierFormationLGT( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	StaticTextId = new wxStaticText( this, wxID_ANY, wxT("Rentrez l'id de la formation a modifier"), wxDefaultPosition, wxDefaultSize, 0 );
	StaticTextId->Wrap( -1 );
